<template>
  <div class="mt-24">
    <h2 class="text-center text-slate-500 font-bold">基于 Nuxt 3 + Vue 3 生态，集成主流开发平台</h2>
    <div
    ...
    >
      ...
      <Icon class="h-8 md:h-14" name="simple-icons:github" size="48" />
      <Icon class="h-8 md:h-14" name="simple-icons:supabase" size="48" />
      <Icon class="h-8 md:h-12" name="simple-icons:vercel" size="48" />
      <Icon class="h-8 md:h-12" name="simple-icons:cloudflare" size="48" />
    </div>
  </div>
</template>
